        ...
        <ul className="flex flex-col gap-0.5 mt-4 text-xs w-full text-muted-foreground">
          <li className="flex justify-between items-center gap-1.5">
            ...
            <div className="flex space-x-1">
              ...
              <button
                className="cursor-pointer border-b border-transparent transition text-mfi-action-box-highlight hover:border-mfi-action-box-highlight disabled:opacity-50 disabled:cursor-not-allowed disabled:cursor-default disabled:hover:border-transparent"
