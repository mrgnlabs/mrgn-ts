...
>(({ className, isBgGlass = false, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "dialog-overlay fixed inset-0 h-screen z-50 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
  ...
  (
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "outline-none fixed h-full md:max-h-screen border border-border/50 overflow-auto md:h-auto left-0 md:left-[50%] z-50 flex flex-col justify-center w-full md:translate-x-[-50%] md:translate-y-[-50%] gap-4 bg-mfi-action-box-background shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 sm:rounded-lg md:w-full",
          position === "center" &&
      ...
      >
        ...
        {!hideClose && (
          <DialogPrimitive.Close
            className={cn(
              "absolute right-4 top-4 rounded-full opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-mfi-action-box-background data-[state=open]:text-muted-foreground",
              closeClassName
            )}
          >
            <IconX size={20} />
