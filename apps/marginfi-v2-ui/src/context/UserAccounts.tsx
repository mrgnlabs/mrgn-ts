...
interface UserAccountsState {
  ...
  userAccounts: MarginfiAccountWrapper[];
...
const UserAccountsProvider: FC<{
  ...
  const [userAccounts, setUserAccounts] = useState<MarginfiAccountWrapper[]>([]);
  const [selectedAccount, setSelectedAccount] = useState<MarginfiAccountWrapper | null>(null);
