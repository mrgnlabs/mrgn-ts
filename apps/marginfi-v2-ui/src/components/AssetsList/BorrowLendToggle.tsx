...
const BorrowLendToggleMobile = styled(({ isInLendingMode, setIsInLendingMode, ...switchProps }: BorrowLendToggleProps) => {
  const handleChange = () => {
    setIsInLendingMode((prev) => !prev);
  };
...
export { BorrowLendToggle, BorrowLendToggleMobile };
