  ...
  return (
    <ToggleButton
      ...
      className={`w-1/4 text-sm ${
        index === arr.length - 1 ? "pl-5 sm:pl-[40px] sm:pr-[30px] ml-[-20px] sm:ml-[-30px]" : ""
      }`}
      sx={{
        backgroundColor:
          selectedProduct === value && value === "⚡️stake" ? "#DCE85D !important" : "#0D1011 !important",
        ...
        borderRight: index === 2 || index === 3 ? "solid #62672E !important" : "solid #0D1011 !important",
        borderTopLeftRadius: index === 0 ? "30px !important" : "0px !important",
        borderBottomLeftRadius: index === 0 ? "30px !important" : "0px !important",
        borderTopRightRadius: index === 2 || index === 3 ? "30px !important" : "0px !important",
        borderBottomRightRadius: index === 2 || index === 3 ? "30px !important" : "0px !important",
