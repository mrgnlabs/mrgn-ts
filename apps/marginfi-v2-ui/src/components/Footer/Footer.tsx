...
const Footer: FC = () => {
  ...
  return (
    <header>
      <div
        className="hidden sm:flex fixed w-full bottom-0 h-[34px] z-20 gap-4 bg-[#0F1111] border-t border-[#4E5257]"
      >
        ...
        <div className="flex gap-4 items-center justify-center border-r border-[#4E5257] pr-4">
          <div className="flex items-center h-full">
            ...
            >
              <svg
                fill="#868E95"
                className="cursor-pointer glow-on-hover text-lg"
              >
                <path 
                  strokeWidth={1.5}
        ...
        <div className="flex gap-4 items-center justify-center pt-1 border-r border-[#4E5257] pr-4">
          <Link href="https://discord.gg/A28mabSG" target="_blank" rel="noopener noreferrer" className="p-0 m-0 h-full flex justify-center items-center">
          ...
          <Link href="https://twitter.com/marginfi" target="_blank" rel="noopener noreferrer" className="p-0 m-0 h-full flex justify-center items-center">
          <TwitterIcon className="pb-1 text-xl cursor-pointer glow-on-hover text-[#868E95]" />
          </Link>
          <Link href="https://t.me/mrgncommunity" target="_blank" rel="noopener noreferrer" className="p-0 m-0 h-full flex justify-center items-center">
            <TelegramIcon className="pb-1 text-xl cursor-pointer glow-on-hover text-[#868E95]"/>
          </Link>
          <Link href="https://docs.marginfi.com/" target="_blank" rel="noopener noreferrer" className="p-0 m-0 h-full flex justify-center items-center">
            <AutoStoriesOutlinedIcon className="pb-1 text-xl cursor-pointer glow-on-hover text-[#868E95]"/>
          </Link>
          <Link href="https://mrgn.grafana.net/public-dashboards/a2700f1bbca64aeaa5582a90dbaeb276?orgId=1&refresh=1m" target="_blank" rel="noopener noreferrer" className="p-0 m-0 h-full flex justify-center items-center">
