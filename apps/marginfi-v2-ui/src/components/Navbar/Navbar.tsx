      ...
      <nav className="fixed w-full top-0 h-[64px] z-10 backdrop-blur-md">
        ...
        >
          ...
          <div className="h-full flex justify-center items-center gap-4 z-10">
            ...
            >
              <Button
                className="h-full w-1/4 min-w-fit max-w-1/4 text-sm flex justify-center items-center normal-case rounded-2xl bg-gradient-to-r to-[#FFF3D0] from-[#C5B893] text-black"
                variant="text"
              >
                Submit Feedback
              </Button>
