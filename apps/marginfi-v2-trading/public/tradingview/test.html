...
<html>
	<head>
		...
		<title>TradingView Advanced Charts demo -- testing mess</title>
		...
		<script type="text/javascript">
			...
			function initOnReady() {
				...
				widget.onChartReady(function() {
					...
					widget.onShortcut("ctrl+alt+s", function() {
