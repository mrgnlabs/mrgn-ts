...
import { IconChevronLeft, IconInfoCircle, IconLoader2 } from "@tabler/icons-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div className="space-y-2 text-sm">
              <Label className="font-medium">Mint address</Label>
            ...
            <div className="space-y-2 text-sm">
              <Label className="font-medium">Token decimals</Label>
