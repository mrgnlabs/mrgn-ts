...
const YieldItem = ({
  ...
  const {
    ...
    const bankCapLending = getBankCapData(bank, true);
    const bankCapBorrowing = getBankCapData(bank, false);
    const bankDepositData = getDepositsData(bank, true);
    const bankBorrowData = getDepositsData(bank, false);
