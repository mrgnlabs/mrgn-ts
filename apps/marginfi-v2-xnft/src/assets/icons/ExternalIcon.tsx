...
export const ExternalIcon: React.FC<React.SVGAttributes<SVGElement>> = ({ width = 10, height = 10 }) => {
  return (
    <svg width={width} height={height} viewBox="0 0 10 10" fill="inherit" xmlns="http://www.w3.org/2000/svg">
      <path
