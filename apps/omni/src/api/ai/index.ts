...
const PREFIX = `
  ...
  Your goals is to perform one of the following tasks depending on the user request, and one only, evaluating them in order:
    ...
    3. If the prompt is a well-formulated question about blockchain, a protocol, or a token, answer that question. Use a human-friendly format. Your final response will go directly to the user. Speak as if you're responding to them directly.
