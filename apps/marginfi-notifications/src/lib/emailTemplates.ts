        ...
        <td class="container">
          <div class="content">
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
              ...
              <tr>
                <td class="wrapper">
                  <img class="header-image" src="https://app.marginfi.com/mrgn-white.svg" />
                  <h1 class="title"><span style="padding-right: 5px;">⚠</span>️ Account Health Alert</h1>
                  <p>
                      ...
                      <tr>
                        <td align="left">
                          <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                              <tr>
                                <td align="center" style="text-align: center;"><a href="href="https://app.marginfi.com"" target="_blank">login to marginfi</a></td>
                              </tr>
                            </tbody>
                          </table>
                        </td>
