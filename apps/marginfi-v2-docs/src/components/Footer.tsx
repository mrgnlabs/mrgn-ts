  ...
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 sm:flex-row dark:border-white/5">
      <p className="text-xs text-zinc-600 dark:text-zinc-400">
        {new Date().getFullYear()} © MRGN, INC. All rights reserved.
      </p>
      <div className="flex gap-4">
        <SocialLink href="https://x.com/marginfi" icon={XIcon}>
          Follow us on X
        </SocialLink>
        <SocialLink href="https://github.com/mrgnlabs" icon={GitHubIcon}>
          Follow us on GitHub
        </SocialLink>
        {/* <SocialLink href="https://discord.com/invite/c2kNj7y9w8" icon={DiscordIcon}>
