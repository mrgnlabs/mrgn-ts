  ...
  return (
    <button
      ...
      className={clsx(
        ...
        copied
          ? 'bg-mrgn-chartreuse/10 ring-1 ring-inset ring-mrgn-chartreuse/20'
    ...
    >
      ...
      <span
        aria-hidden={!copied}
        className={clsx(
          'pointer-events-none absolute inset-0 flex items-center justify-center text-mrgn-chartreuse transition duration-300',
          !copied && 'translate-y-1.5 opacity-0',
        )}
      >
        Copied!
            ...
            <Tab
              className={clsx(
                ...
                childIndex === selectedIndex
                  ? 'border-mrgn-chartreuse/90 text-mrgn-chartreuse/70'
