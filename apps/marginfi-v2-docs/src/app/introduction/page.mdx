...
## Incentives Mechanism Explained {{ tag: '', label: '' }}

## Lend-Side Incentives
To grow available liquidity, asset issuers may partner with marginfi to offer rewards to users who deposit specific assets.

<Note>For example, users who lend during an incentives campaign may earn bonus rewards in addition to base yield.</Note>

**Qualifying Criteria**
* Deposit the incentivized asset into marginfi
* Rewards are based on the USD value of your deposit

## Borrow-Side Incentives
To encourage borrowing against certain collateral, issuers may offer borrow-side rewards through marginfi.

<Note>For example, users who borrow an asset against a specific collateral type may earn additional rewards based on their position size.</Note>

**Qualifying Criteria**
* Hold a borrow position with the specified collateral and borrow asset
* Participation amount is the smaller of your collateral deposit or borrow amount (USD value)

## Distribution
Rewards are airdropped weekly to eligible users; no manual action required. Just hold your qualifying positions to earn during the campaign.