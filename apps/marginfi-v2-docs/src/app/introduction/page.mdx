...
The user can expect to receive their rewards as an airdrop directly to their wallets at the end of each week during the given incentives campaign. There is nothing you need to do manually to receive your airdrop (no claiming process) except hold your qualifying positions to automatically earn your share. (e.g., hold your jitoSOL deposit and SOL borrow in order to earn JTO borrow-side emissions, per the example above.)
