...
When e-mode launches, marginfi will support borrowing and lending between SOL and various LSTs (liquid staking tokens) with up to 10x leverage. Assets are grouped into configuration bands for risk calibration:

* **Risk Tier 1 Assets** (**LST_T1**): mSOL, bSOL, LST, jupSOL, jitoSOL
* **Risk Tier 2 Assets** (**LST_T2**): INF, hSOL, bbSOL, bnSOL

| **Lending Asset** | **Borrowing Asset**  | **Normal Weight** | **Emode Weight** |
|-------------------|----------------------|-------------------|------------------|
| SOL               | LST_T1               | 0.80              | 0.90             |
| SOL               | LST_T2               | 0.80              | 0.85             |
| LST_T1            | SOL                  | 0.60              | 0.90             |
| LST_T1            | LST_T2               | 0.60              | 0.85             |
| LST_T2            | SOL                  | 0.60              | 0.85             |
| LST_T2            | LST_T1               | 0.60              | 0.85             |
...
To **view available e-mode pairings**, select the **e-mode** category in the asset menu selection on <Button href="https://app.marginfi.com" variant="text"><>the Lend page of app.marginfi.com</></Button>. (You can also find this button on the <Button href="https://app.marginfi.com/Portfolio" variant="text"><>Portfolio page</></Button>.)
...
Select which asset(s) you want to lend or borrow via the dropdown selections to view e-mode pairs.

For example, if I were to lend PYUSD, I could activate an e-mode advantage in my marginfi account by borrowing either USDC, UXD or SOL against my PYUSD collateral.

<Note>
This example is just for demonstration purposes. PYUSD, USDC and UXD are not eligible for e-mode at the time of this writing.
</Note>
...
From the same widget, you can select the **Strategies** tab to execute borrows against the collateral you already have posted to activate an e-mode advantage.
...
Once you have an active e-mode pairing in your account, you'll notice the e-mode icon is colored purple for the asset(s) that have an active e-mode advantage.

<Note>
In order to maintain your account's e-mode advantage, you cannot borrow any asset that is not e-mode compatible within that account.
</Note>
...
You can also view your active e-mode pairings by toggling the **Highlight e-mode** button on <Button href="https://app.marginfi.com/Portfolio" variant="text"><>the Portfolio page</></Button>
