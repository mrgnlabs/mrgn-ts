...
When e-mode launches, marginfi will support various LSTs-SOL pairings, allowing the user to borrow and lend LSTs vs. SOL with **up to 10x leverage**:
