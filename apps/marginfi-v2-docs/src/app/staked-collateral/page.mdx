...
Meaning, if you natively staked $SOL to any of these validators, you can borrow against your stake account on marginfi. Note that the app will only display stake pools for validators your wallet has have active stake accounts for.
</Note>
...
Validators can contact @masterzorgon on Telegram or review the technical documentation to enable this feature for their stakers.
