...
export const metadata = {
  ...
  description: 'Staked Collateral is a new feature on marginfi that — for the firs time on $SOLana — allows users to borrow $$SOL against their native stake for any validator. 
}
