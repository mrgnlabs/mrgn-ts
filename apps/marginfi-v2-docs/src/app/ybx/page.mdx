...
<Note>
    The $YBX product is double-audited and production-ready. However, the marginfi team has decided to postpone the launch of $YBX in light of Solana congestion issues. 
    The marginfi put a lot of consideration into this decision, and we are working deligently to improve core Solana infrastructure to make $YBX a reality for all Solana DeFi users.
</Note>
