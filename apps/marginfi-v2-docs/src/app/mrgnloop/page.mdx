...
export const metadata = {
  ...
  description: 'A User Guide to Trading with Leverage',
}

# mrgnloop: A User Guide to Trading with Leverage

mrgnloop allows you to open leveraged long positions using marginfi flashloans. {{ className: 'lead' }}
...
mrgnloop uses flashloans to create a secure and flexible method for optimizing capital and **enabling both long and short strategies**, all within a secure and user-friendly platform.
