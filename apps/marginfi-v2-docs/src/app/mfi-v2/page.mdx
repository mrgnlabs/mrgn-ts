...
marginfi v2 has been rigorously audited both internally and by <Button href="https://osec.io/" variant="text"><>Ottersec</></Button> and <Button href="https://www.sec3.dev/" variant="text"><>Sec3</></Button>. <Button href="https://github.com/mrgnlabs/marginfi-v2/tree/main/audits" variant="text"><>Audits can be found here</></Button>.
