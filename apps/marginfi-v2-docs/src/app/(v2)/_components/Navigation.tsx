...
const baseNavigation: Array<NavGroup> = [
  {
...
// Process the navigation to add v2 prefix to all links
export const navigation: Array<NavGroup> = baseNavigation.map(group => ({
  ...group,
...
export function Navigation(props: React.ComponentPropsWithoutRef<'nav'>) {
  return (
    <nav {...props}>
      <ul role="list">
        <TopLevelNavItem href="/v2">API</TopLevelNavItem>
