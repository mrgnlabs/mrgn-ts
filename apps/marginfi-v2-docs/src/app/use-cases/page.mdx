...
Below are some ideas for the kinds of applications you can build on the marginfi liquidity layer. The possibilities are endless! {{ className: 'lead' }}

<Note>
    If you do not see a use case that matches what you're trying to build, please reach out to our 
