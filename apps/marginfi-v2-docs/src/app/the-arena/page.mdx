...
The key factor driving the fluctuations in APY for lending different assets is the dynamic balance of supply and demand. When an asset is in high demand for borrowing (due to prevalent trading strategies), the platform incentivizes more users to supply that asset by offering higher yields.
