...
The <Button href="https://www.npmjs.com/package/@mrgnlabs/marginfi-client-v2" variant="text"><>mrgn-client-v2</></Button> and <Button href="https://www.npmjs.com/package/@mrgnlabs/mrgn-common" variant="text"><>mrgn-common</></Button> NPM packages are the official TypeScript SDKs for interacting with the marginfi protocol. You can use these SDKs in your Node.js frontend and backend to perform tasks like creating banks, making deposits to existing banks, and more.  {{ className: 'lead' }}
...
npm install @mrgnlabs/mrgn-client-v2 @mrgnlabs/mrgn-common
```

```bash {{ title: 'Using Yarn' }}
yarn add @mrgnlabs/mrgn-client-v2 @mrgnlabs/mrgn-common
```
