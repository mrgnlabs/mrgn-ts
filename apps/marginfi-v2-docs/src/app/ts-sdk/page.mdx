...
### Create A Single Pool Account For A Validator
This allows the stake accounts to be tokenized. (Note: it will cost approximately 1.1 SOL to create the single pool account.)
...
### Create A Stake Pool As A Bank On Marginfi 
This way, you can post your native stake account(s) as collateral on marginfi.
...
### Deposit Into A Single Pool And Receive A Receipt Token
...
### Borrow Against Your Collateralized Stake Accounts
