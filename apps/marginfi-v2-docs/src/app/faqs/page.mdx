...
## Are my deposits on mrgnlend assiociated with my positions on The Arena? {{ tag: '', label: '' }}
No, all positions on The Arena are completely isolated from the token groups on mrgnlend. The trading and borrow-lend activity that happens on either platform will have no affect on each other.
