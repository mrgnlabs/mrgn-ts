...
## How do emissions work? {{ tag: '', label: '' }}
For banks that are offering emissin rewards, rewards are earned on open positions and must be claimed before they expire, otherwise they're permanently lost – we'll notify you in the app when rewards are available to claim.
