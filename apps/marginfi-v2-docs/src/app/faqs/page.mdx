...
When borrowed positions fall below requirements and are liquidated, liquidated borrowers (a.k.a. liquidatees) are penalized through a liquidation fee. This fee amounts to 5% of the liquidated assets, and is equally distributed among the liquidator and the insurance fund of the bank for the liquidated token.
...
There are no fees for holding or acquiring LST. There is only a fee for withdrawing LST. 
